...
AIGeneratorLattice::AIGeneratorLattice(BattleObjectAccessor* accessor, BattleActor* owner, int x_num, int y_num, int z_num, float x_padding, float y_padding, float z_padding) :
	AIGenerator(accessor, owner),
	X_POINT_NUM(x_num),
	Y_POINT_NUM(y_num),
	Z_POINT_NUM(z_num),
	X_PADDING(x_padding),
...
AIGeneratorLattice::~AIGeneratorLattice() {
...
void AIGeneratorLattice::AlignmentPoints(void) {
